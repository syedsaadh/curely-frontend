...
import { editAppointment, toggleDoneAction } from '../../../redux/Appointments/actions';
import { fetchAll as fetchDepartments } from '../../../redux/Departments/actions';
...
interface Props extends FormComponentProps {
  ...
  toggleDoneAction: actionstoggleDoneAction;
...
class AppointmentEditModal extends React.Component<Props> {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (nextProps.doneAction === 'edit') {
      ...
      this.props.fetchPatient(data.patient.id);
