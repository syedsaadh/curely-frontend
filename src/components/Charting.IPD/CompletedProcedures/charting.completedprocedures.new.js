...
class CompletedProceduresNew extends React.Component<Props, State> {
  componentWillMount() {
  ...
  onDelete = () => {
    ...
    this.props.deleteCompletedProcedures(visitId);
  };
...
const mapDispatchToProps = dispatch => ({
  ...
  deleteCompletedProcedures: visitId => dispatch(deleteCompletedProcedures(visitId)),
});
